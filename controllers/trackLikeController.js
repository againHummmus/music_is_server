...
class TrackLikeController extends Controller {
  ...
  async create(req, res, next) {
    try {
      ...
      const trackLike = await trackLikeService.createTrackLike({ userId, trackId });
  ...
  async search(req, res, next) {
    try {
      ...
      const trackLikes = await trackLikeService.searchTrackLikes({
        userId,
        trackId,
  ...
  async delete(req, res, next) {
    try {
      ...
      const deletedTrackLike = await trackLikeService.deleteTrackLike({ userId, trackId });
